...
import { FaBuilding, FaCheckCircle, FaFileAlt, FaHourglassHalf, FaMoneyBillWave, FaUsers, FaTimesCircle } from 'react-icons/fa'

const AdminSummary = () => {
  return (
    <div className='p-6'>
        <h3 className='text-2xl font-bold'>Dashboard Overview</h3>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-18 mt-6'>
            ...
            <SummaryCard icon={<FaMoneyBillWave/>} text="Monthly Salary" number="$700" color="bg-red-600"/>
        ...
        <div className='mt-12'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-6'>
            <SummaryCard icon={<FaFileAlt/>} text="Leave Applied" number={5} color="bg-blue-600"/>

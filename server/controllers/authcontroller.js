...
//     text:`Welcome to MERN AUTH APP. We're glad to have you on board With email id: ${email}`
//   }
...
try {
  ...
  try {
     await transporter.sendMail(mailOptions);
    console.log("Welcome email sent sucessfully to:", email);
  } catch (emailError) {
